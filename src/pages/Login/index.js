        ...
        <div className={classes.bgDescription}>
          <div className={classes.bgContent}>
            ...
            <Typography variant="body1" style={{ marginTop:14 }}>
              OpenMarkets is the leading online platform for buying, selling<br/> 
            ...
            <div className={classes.card}>
              <Card className={toggleSelect? classes.cardLeftRoot : classes.cardLeftRootInactive}>
                <CardContent style={{ padding:2 }}>
                  <Typography variant="h3" style={{ padding: "4px 0" }}>
                    EQUIPPED
                  </Typography>
                  <Divider/>
                  <div style={{ display: "flex", textAlign: "left" }}>
                    ...
                    <div style={{ padding: "8px 10px" }}>
                      <Typography variant="subtitle2">
                        Medical equipments to outfit your Clinic, Surgery Center or Hospital
                      </Typography>
              ...
              <Typography variant="h5" className={classes.bottomLeftLabel}>promotion</Typography>
            </div>
            <div className={classes.card}>
              <Card className={toggleSelect? classes.cardRightRoot : classes.cardRightRootActive}>
                <CardContent style={{ padding:2 }}>
                  ...
                  <div style={{ display: "flex", textAlign: "left" }}>
                    ...
                    <div style={{ padding: "8px 10px" }}>
                      <Typography variant="subtitle2">
                        Aiden delivers vetted medical supplies to keep our frontlines safe.
                      </Typography>
                      <Typography style={{ marginTop: "8px" }}>
                        <Link to ="#" className={classes.inlineLink}>
              ...
              <Typography variant="h5" className={classes.bottomRightLabel}>promotion</Typography>
            </div>
